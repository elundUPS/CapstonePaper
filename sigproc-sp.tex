...
\title{Computer Science Capstone Project {\ttlit Fit n' Lift}\titlenote{(Does NOT produce the permission block, copyright information nor page numbering). For use with ACM\_PROC\_ARTICLE-SP.CLS. Supported by ACM.}}
